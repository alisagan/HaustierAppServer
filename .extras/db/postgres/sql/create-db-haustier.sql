...
-- (3) In Windows das Verzeichnis "C:/Zimmermann/volumes/postgres/tablespace/haustier" anlegen
--     Siehe .extras\compose\postgres\compose.yml
-- (4) 2. PowerShell:
--     cd .extras\compose\backend\postgres
--     docker compose exec db bash
--        chown postgres:postgres /var/lib/postgresql/tablespace
--        chown postgres:postgres /var/lib/postgresql/tablespace/haustier
...
-- (7) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-haustier.sql
--        psql --dbname=haustier --username=haustier --file=/sql/create-schema-haustier.sql
--        exit
...
CREATE ROLE haustier LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE haustier;

GRANT ALL ON DATABASE haustier TO haustier;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE haustierspace OWNER haustier LOCATION '/var/lib/postgresql/tablespace/haustier';
