...
# Aufruf:   docker build --tag juergenzimmermann/haustier:2025.4.1-bookworm .
#               ggf. --progress=plain
#               ggf. --no-cache
#           Get-Content Dockerfile | docker run --rm --interactive hadolint/hadolint:2.12.1-beta-debian
#               Linux:   cat Dockerfile | docker run --rm --interactive hadolint/hadolint:2.12.1-beta-debian
#           docker save juergenzimmermann/haustier:2025.4.1-bookworm > haustier.tar
#           docker network ls
...
LABEL org.opencontainers.image.title="haustier" \
  org.opencontainers.image.description="Appserver haustier mit Basis-Image Debian Bookworm" \
  org.opencontainers.image.version="2025.4.1-bookworm" \
  org.opencontainers.image.licenses="GPL-3.0-or-later" \
  org.opencontainers.image.authors="gaal1019@h-ka.de"
